...
ALTER TABLE estudante ALTER COLUMN id RESTART WITH 3;
...
ALTER TABLE vaga ALTER COLUMN id RESTART WITH 3;
...
ALTER TABLE inscricao ALTER COLUMN id RESTART WITH 2;